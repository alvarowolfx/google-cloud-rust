...
impl std::convert::From<QueryCreationMetadata> for crate::generated::QueryMetadata {
    fn from(val: QueryCreationMetadata) -> Self {
        crate::generated::QueryMetadata {
            cache_hit: val.cache_hit,
            creation_time: val.creation_time,
            dml_stats: val.dml_stats,
            end_time: val.end_time,
            errors: val.errors,
            job_complete: val.job_complete,
            job_creation_reason: val.job_creation_reason,
            job_reference: val.job_reference,
            kind: val.kind,
            location: val.location,
            num_dml_affected_rows: val.num_dml_affected_rows,
            page_token: val.page_token,
            query_id: val.query_id,
            schema: val.schema,
            session_info: val.session_info,
            start_time: val.start_time,
            total_bytes_billed: val.total_bytes_billed,
            total_bytes_processed: val.total_bytes_processed,
            total_rows: val.total_rows,
            total_slot_ms: val.total_slot_ms,
            ..Default::default()
        }
    }
}
